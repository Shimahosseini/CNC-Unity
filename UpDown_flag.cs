...
public class UpDown_flag : MonoBehaviour
{//Beginning of leftToRight_Oscillating class
    ...
    public float speed;
    public static bool FlagMotor3Arduino;
    ...
    {//Beginning of Update function
        ...
        FlagMotor3Arduino = Automations.flagMotor1Arduino;

        if (FlagMotor3Arduino)
        {
    ...
    {//Beginning of FixedUpdate function
        FlagMotor3Arduino = Automations.flagMotor3Arduino;
        if (FlagMotor3Arduino)
        {
